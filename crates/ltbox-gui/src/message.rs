...
pub(crate) enum Message {
    ...
    LogSaved(crate::LogSaveSource, std::path::PathBuf, Result<(), String>),
    Window(WindowMsg),
    Flash(FlashMsg),
    Root(RootMsg),
    Unroot(UnrootMsg),
...
pub(crate) enum UnrootMsg {
    ...
    BackupsLoaded(
        std::time::Instant,
        Result<Vec<crate::backup::BackupFolderEntry>, String>,
    ),
    ManifestLoaded(std::time::Instant, crate::backup::BackupManifestDialog),
    UnrootSelectLoader,
