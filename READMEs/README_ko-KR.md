...
**교육 목적으로만 사용하세요.** 펌웨어를 수정하면 기기가 벽돌이 되거나 데이터가 사라지거나 보증이 무효화될 수 있습니다. 개발자는 **어떠한 책임도 지지 않으며**, 모든 책임은 사용자 본인에게 있습니다. **위험을 감수하고 사용하세요.**
...
LTBox는 개인 취미 프로젝트이며, 후원이나 스폰서 등 어떠한 금전적인 지원도 받지 않습니다. 대신 기여는 언제나 환영합니다. 이슈, 풀 리퀘스트, 번역 모두 큰 도움이 됩니다.
